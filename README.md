...
In Clustering_transform we make an analysis of the different types of data treatments and look for the optimal number of clusters for various models, relying on a dendrogram, the elbow method and shilouette score.
